...
[![ansible-lint.yml](https://github.com/linux-system-roles/auditd/actions/workflows/ansible-lint.yml/badge.svg)](https://github.com/linux-system-roles/auditd/actions/workflows/ansible-lint.yml) [![ansible-test.yml](https://github.com/linux-system-roles/auditd/actions/workflows/ansible-test.yml/badge.svg)](https://github.com/linux-system-roles/auditd/actions/workflows/ansible-test.yml) [![codespell.yml](https://github.com/linux-system-roles/auditd/actions/workflows/codespell.yml/badge.svg)](https://github.com/linux-system-roles/auditd/actions/workflows/codespell.yml) [![markdownlint.yml](https://github.com/linux-system-roles/auditd/actions/workflows/markdownlint.yml/badge.svg)](https://github.com/linux-system-roles/auditd/actions/workflows/markdownlint.yml) [![qemu-kvm-integration-tests.yml](https://github.com/linux-system-roles/auditd/actions/workflows/qemu-kvm-integration-tests.yml/badge.svg)](https://github.com/linux-system-roles/auditd/actions/workflows/qemu-kvm-integration-tests.yml) [![shellcheck.yml](https://github.com/linux-system-roles/auditd/actions/workflows/shellcheck.yml/badge.svg)](https://github.com/linux-system-roles/auditd/actions/workflows/shellcheck.yml) [![tft.yml](https://github.com/linux-system-roles/auditd/actions/workflows/tft.yml/badge.svg)](https://github.com/linux-system-roles/auditd/actions/workflows/tft.yml) [![tft_citest_bad.yml](https://github.com/linux-system-roles/auditd/actions/workflows/tft_citest_bad.yml/badge.svg)](https://github.com/linux-system-roles/auditd/actions/workflows/tft_citest_bad.yml) [![woke.yml](https://github.com/linux-system-roles/auditd/actions/workflows/woke.yml/badge.svg)](https://github.com/linux-system-roles/auditd/actions/workflows/woke.yml)

![auditd](https://github.com/linux-system-roles/auditd/workflows/tox/badge.svg)
...
Deprecated option (ignored by current auditd). If non-empty, it is written to
the config file; otherwise the line is omitted.
...
Deprecated option. If non-empty, written to the config; otherwise omitted.
...
Maximum parallel connections per address (`0–1024`).
...
Audit rules: backlog buffer size (`-b`).
...
Audit rules: failure mode flag (`-f`).
...
Audit rules: audit enable flag (`-e`).
...
Default architecture field for syscall rules (for example `b64`).
...
List of rule dictionaries, same shape as
[robertdebock/ansible-role-auditd](https://github.com/robertdebock/ansible-role-auditd#example-playbook):

| Keys | Purpose |
| --- | --- |
| `file` | Path for a path watch (`-w`); optional `permissions` (`read`, `write`, `execute`, `attribute_change`), optional `filters` (list of extra `-F` fragments) |
| `syscall` | Syscall rule: requires `action`, `filter`, `syscall`; optional `arch`, `filters` |
| `action`, `filter` | For general rules without `file`/`syscall`; optional `filters` |
| `keyname` | Audit key (`-k`) for every rule |
