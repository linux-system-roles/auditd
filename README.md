...
Audit rules: maximum messages per second (`-r`).  The value of `null` means to omit the setting.
...
Audit rules: backlog wait time.  The value of `null` means to omit the setting.
